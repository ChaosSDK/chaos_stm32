...
C_SRCS += \
../Core/stm32_printf/stm32_printf.c 

C_DEPS += \
./Core/stm32_printf/stm32_printf.d 

OBJS += \
./Core/stm32_printf/stm32_printf.o 


# Each subdirectory must supply rules for building sources it contributes
Core/stm32_printf/%.o Core/stm32_printf/%.su Core/stm32_printf/%.cyclo: ../Core/stm32_printf/%.c Core/stm32_printf/subdir.mk
...
clean: clean-Core-2f-stm32_printf

clean-Core-2f-stm32_printf:
	-$(RM) ./Core/stm32_printf/stm32_printf.cyclo ./Core/stm32_printf/stm32_printf.d ./Core/stm32_printf/stm32_printf.o ./Core/stm32_printf/stm32_printf.su

.PHONY: clean-Core-2f-stm32_printf
