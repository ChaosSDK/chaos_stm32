...
C_SRCS += \
../Core/chos_sdk/callback_manager/callback_manager.c \
../Core/chos_sdk/callback_manager/callback_manager_test.c 

C_DEPS += \
./Core/chos_sdk/callback_manager/callback_manager.d \
./Core/chos_sdk/callback_manager/callback_manager_test.d 

OBJS += \
./Core/chos_sdk/callback_manager/callback_manager.o \
./Core/chos_sdk/callback_manager/callback_manager_test.o 


# Each subdirectory must supply rules for building sources it contributes
Core/chos_sdk/callback_manager/%.o Core/chos_sdk/callback_manager/%.su Core/chos_sdk/callback_manager/%.cyclo: ../Core/chos_sdk/callback_manager/%.c Core/chos_sdk/callback_manager/subdir.mk
...
clean: clean-Core-2f-chos_sdk-2f-callback_manager

clean-Core-2f-chos_sdk-2f-callback_manager:
	-$(RM) ./Core/chos_sdk/callback_manager/callback_manager.cyclo ./Core/chos_sdk/callback_manager/callback_manager.d ./Core/chos_sdk/callback_manager/callback_manager.o ./Core/chos_sdk/callback_manager/callback_manager.su ./Core/chos_sdk/callback_manager/callback_manager_test.cyclo ./Core/chos_sdk/callback_manager/callback_manager_test.d ./Core/chos_sdk/callback_manager/callback_manager_test.o ./Core/chos_sdk/callback_manager/callback_manager_test.su

.PHONY: clean-Core-2f-chos_sdk-2f-callback_manager
