...
C_SRCS += \
../Core/chos_sdk/smart_assert/smart_assert.c 

C_DEPS += \
./Core/chos_sdk/smart_assert/smart_assert.d 

OBJS += \
./Core/chos_sdk/smart_assert/smart_assert.o 


# Each subdirectory must supply rules for building sources it contributes
Core/chos_sdk/smart_assert/%.o Core/chos_sdk/smart_assert/%.su Core/chos_sdk/smart_assert/%.cyclo: ../Core/chos_sdk/smart_assert/%.c Core/chos_sdk/smart_assert/subdir.mk
...
clean: clean-Core-2f-chos_sdk-2f-smart_assert

clean-Core-2f-chos_sdk-2f-smart_assert:
	-$(RM) ./Core/chos_sdk/smart_assert/smart_assert.cyclo ./Core/chos_sdk/smart_assert/smart_assert.d ./Core/chos_sdk/smart_assert/smart_assert.o ./Core/chos_sdk/smart_assert/smart_assert.su

.PHONY: clean-Core-2f-chos_sdk-2f-smart_assert
