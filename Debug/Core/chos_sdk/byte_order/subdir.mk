...
C_SRCS += \
../Core/chos_sdk/byte_order/byte_order.c 

C_DEPS += \
./Core/chos_sdk/byte_order/byte_order.d 

OBJS += \
./Core/chos_sdk/byte_order/byte_order.o 


# Each subdirectory must supply rules for building sources it contributes
Core/chos_sdk/byte_order/%.o Core/chos_sdk/byte_order/%.su Core/chos_sdk/byte_order/%.cyclo: ../Core/chos_sdk/byte_order/%.c Core/chos_sdk/byte_order/subdir.mk
...
clean: clean-Core-2f-chos_sdk-2f-byte_order

clean-Core-2f-chos_sdk-2f-byte_order:
	-$(RM) ./Core/chos_sdk/byte_order/byte_order.cyclo ./Core/chos_sdk/byte_order/byte_order.d ./Core/chos_sdk/byte_order/byte_order.o ./Core/chos_sdk/byte_order/byte_order.su

.PHONY: clean-Core-2f-chos_sdk-2f-byte_order
