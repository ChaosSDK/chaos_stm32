...
C_SRCS += \
../Core/chos_sdk/slip/example/main.c 

C_DEPS += \
./Core/chos_sdk/slip/example/main.d 

OBJS += \
./Core/chos_sdk/slip/example/main.o 


# Each subdirectory must supply rules for building sources it contributes
Core/chos_sdk/slip/example/%.o Core/chos_sdk/slip/example/%.su Core/chos_sdk/slip/example/%.cyclo: ../Core/chos_sdk/slip/example/%.c Core/chos_sdk/slip/example/subdir.mk
...
clean: clean-Core-2f-chos_sdk-2f-slip-2f-example

clean-Core-2f-chos_sdk-2f-slip-2f-example:
	-$(RM) ./Core/chos_sdk/slip/example/main.cyclo ./Core/chos_sdk/slip/example/main.d ./Core/chos_sdk/slip/example/main.o ./Core/chos_sdk/slip/example/main.su

.PHONY: clean-Core-2f-chos_sdk-2f-slip-2f-example
