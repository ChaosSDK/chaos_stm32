...
C_SRCS += \
../Core/chos_sdk/slip/example_loopback/main.c 

C_DEPS += \
./Core/chos_sdk/slip/example_loopback/main.d 

OBJS += \
./Core/chos_sdk/slip/example_loopback/main.o 


# Each subdirectory must supply rules for building sources it contributes
Core/chos_sdk/slip/example_loopback/%.o Core/chos_sdk/slip/example_loopback/%.su Core/chos_sdk/slip/example_loopback/%.cyclo: ../Core/chos_sdk/slip/example_loopback/%.c Core/chos_sdk/slip/example_loopback/subdir.mk
...
clean: clean-Core-2f-chos_sdk-2f-slip-2f-example_loopback

clean-Core-2f-chos_sdk-2f-slip-2f-example_loopback:
	-$(RM) ./Core/chos_sdk/slip/example_loopback/main.cyclo ./Core/chos_sdk/slip/example_loopback/main.d ./Core/chos_sdk/slip/example_loopback/main.o ./Core/chos_sdk/slip/example_loopback/main.su

.PHONY: clean-Core-2f-chos_sdk-2f-slip-2f-example_loopback
