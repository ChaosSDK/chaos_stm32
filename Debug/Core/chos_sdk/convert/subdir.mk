...
C_SRCS += \
../Core/chos_sdk/convert/convert.c \
../Core/chos_sdk/convert/convert_template.c 

C_DEPS += \
./Core/chos_sdk/convert/convert.d \
./Core/chos_sdk/convert/convert_template.d 

OBJS += \
./Core/chos_sdk/convert/convert.o \
./Core/chos_sdk/convert/convert_template.o 


# Each subdirectory must supply rules for building sources it contributes
Core/chos_sdk/convert/%.o Core/chos_sdk/convert/%.su Core/chos_sdk/convert/%.cyclo: ../Core/chos_sdk/convert/%.c Core/chos_sdk/convert/subdir.mk
...
clean: clean-Core-2f-chos_sdk-2f-convert

clean-Core-2f-chos_sdk-2f-convert:
	-$(RM) ./Core/chos_sdk/convert/convert.cyclo ./Core/chos_sdk/convert/convert.d ./Core/chos_sdk/convert/convert.o ./Core/chos_sdk/convert/convert.su ./Core/chos_sdk/convert/convert_template.cyclo ./Core/chos_sdk/convert/convert_template.d ./Core/chos_sdk/convert/convert_template.o ./Core/chos_sdk/convert/convert_template.su

.PHONY: clean-Core-2f-chos_sdk-2f-convert
