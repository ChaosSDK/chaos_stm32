...
C_SRCS += \
../Core/chos_sdk/protocol_test.c 

C_DEPS += \
./Core/chos_sdk/protocol_test.d 

OBJS += \
./Core/chos_sdk/protocol_test.o 


# Each subdirectory must supply rules for building sources it contributes
Core/chos_sdk/%.o Core/chos_sdk/%.su Core/chos_sdk/%.cyclo: ../Core/chos_sdk/%.c Core/chos_sdk/subdir.mk
...
clean: clean-Core-2f-chos_sdk

clean-Core-2f-chos_sdk:
	-$(RM) ./Core/chos_sdk/protocol_test.cyclo ./Core/chos_sdk/protocol_test.d ./Core/chos_sdk/protocol_test.o ./Core/chos_sdk/protocol_test.su

.PHONY: clean-Core-2f-chos_sdk
