...
C_SRCS += \
../Core/chaos_sdk/smart_assert/smart_assert.c 

C_DEPS += \
./Core/chaos_sdk/smart_assert/smart_assert.d 

OBJS += \
./Core/chaos_sdk/smart_assert/smart_assert.o 


# Each subdirectory must supply rules for building sources it contributes
Core/chaos_sdk/smart_assert/%.o Core/chaos_sdk/smart_assert/%.su Core/chaos_sdk/smart_assert/%.cyclo: ../Core/chaos_sdk/smart_assert/%.c Core/chaos_sdk/smart_assert/subdir.mk
...
clean: clean-Core-2f-chaos_sdk-2f-smart_assert

clean-Core-2f-chaos_sdk-2f-smart_assert:
	-$(RM) ./Core/chaos_sdk/smart_assert/smart_assert.cyclo ./Core/chaos_sdk/smart_assert/smart_assert.d ./Core/chaos_sdk/smart_assert/smart_assert.o ./Core/chaos_sdk/smart_assert/smart_assert.su

.PHONY: clean-Core-2f-chaos_sdk-2f-smart_assert
