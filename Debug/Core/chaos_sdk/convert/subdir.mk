...
C_SRCS += \
../Core/chaos_sdk/convert/convert.c \
../Core/chaos_sdk/convert/convert_template.c 

C_DEPS += \
./Core/chaos_sdk/convert/convert.d \
./Core/chaos_sdk/convert/convert_template.d 

OBJS += \
./Core/chaos_sdk/convert/convert.o \
./Core/chaos_sdk/convert/convert_template.o 


# Each subdirectory must supply rules for building sources it contributes
Core/chaos_sdk/convert/%.o Core/chaos_sdk/convert/%.su Core/chaos_sdk/convert/%.cyclo: ../Core/chaos_sdk/convert/%.c Core/chaos_sdk/convert/subdir.mk
...
clean: clean-Core-2f-chaos_sdk-2f-convert

clean-Core-2f-chaos_sdk-2f-convert:
	-$(RM) ./Core/chaos_sdk/convert/convert.cyclo ./Core/chaos_sdk/convert/convert.d ./Core/chaos_sdk/convert/convert.o ./Core/chaos_sdk/convert/convert.su ./Core/chaos_sdk/convert/convert_template.cyclo ./Core/chaos_sdk/convert/convert_template.d ./Core/chaos_sdk/convert/convert_template.o ./Core/chaos_sdk/convert/convert_template.su

.PHONY: clean-Core-2f-chaos_sdk-2f-convert
