...
C_SRCS += \
../Core/chaos_sdk/byte_order/byte_order.c 

C_DEPS += \
./Core/chaos_sdk/byte_order/byte_order.d 

OBJS += \
./Core/chaos_sdk/byte_order/byte_order.o 


# Each subdirectory must supply rules for building sources it contributes
Core/chaos_sdk/byte_order/%.o Core/chaos_sdk/byte_order/%.su Core/chaos_sdk/byte_order/%.cyclo: ../Core/chaos_sdk/byte_order/%.c Core/chaos_sdk/byte_order/subdir.mk
...
clean: clean-Core-2f-chaos_sdk-2f-byte_order

clean-Core-2f-chaos_sdk-2f-byte_order:
	-$(RM) ./Core/chaos_sdk/byte_order/byte_order.cyclo ./Core/chaos_sdk/byte_order/byte_order.d ./Core/chaos_sdk/byte_order/byte_order.o ./Core/chaos_sdk/byte_order/byte_order.su

.PHONY: clean-Core-2f-chaos_sdk-2f-byte_order
